...
| GET         | `/patient/:patientId`                |                              |                |           | Returns all the information of the patient                                       |
| PATCH         | `/patient/:patientId`                 |                              |                |              | Edit the corresponding value on the patient's profile                                        |
...
| GET         | `/patient/appointments/report/:appointmentId`                 |                              |                |              |Get the specific appointment to grab the report {redundant}                                      |
